...
namespace NetTopologySuite.IO.ShapeFile.Test.Various
{
    ...
    public class PathFinderTest
    {
        ...
        public void BuildStradeFixed()
        {
            ...
            var features = ShapefileReader.ReadAll(path); 
            Assert.AreEqual(703, features.Length);
            ...
            features.SaveToShapefile(shapepath);
        ...
        private Geometry LoadGraphResult()
        {
            ...
            var coll = ShapefileReader.ReadAllGeometries(path).ToGeometryCollection();
        ...
        private void SaveGraphResult(Geometry path)
        {
            ...
            var features = new List<IFeature>(new[] { feature, });
            features.SaveToShapefile(shapepath);
        ...
        public void BuildGraphFromCompleteGraphShapefile()
        {
            ...
            var edges = ShapefileReader.ReadAllGeometries(shapepath).ToGeometryCollection();
