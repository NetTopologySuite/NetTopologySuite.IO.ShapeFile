...
namespace NetTopologySuite.IO.ShapeFile.Test
{
    ...
    public class ShapeRead
    {
        ...
        private static GeometryCollection ReadShape(string shapepath)
        {
            ...
            var geometries = ShapefileReader.ReadAllGeometries(shapepath).ToGeometryCollection(); 
            return geometries;
        }
        ...
        private static void WriteShape(GeometryCollection geometries, string shapepath)
        {
            ...
            //var sfw = new ShapefileGeometryWriter(geometries.Factory);
            //ShapefileGeometryWriter.WriteGeometryCollection(Path.GetFileNameWithoutExtension(shapepath), geometries);
        }
