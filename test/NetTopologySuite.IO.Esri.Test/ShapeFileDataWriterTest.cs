...
namespace NetTopologySuite.IO.ShapeFile.Test
{
    ...
    public class ShapeFileDataWriterTest
    {
        ...
        public void TestCreateEmptyShapefile()
        {
            ...
            var idField = new DbfNumericField("Id");
            using (var writer = ShapefileWriter.Open(filename, ShapeType.Point, idField))
            {
        ...
        private void TestWriteZMValuesShapeFile(bool testM)
        {
            ...
            features.SaveToShapefile("ZMtest");
            ...
            {
                var firstFeature = reader.First();
                var geom = firstFeature.Geometry;
        ...
        public void TestWriteSimpleShapeFile()
        {
            ...
            coll.ToFeatures().SaveToShapefile(@"test_arcview");
        ...
        public void Issue146_ShapeCreationWithInvalidAttributeName()
        {
            ...
            Assert.Throws<ArgumentException>(() => features.SaveToShapefile("invalid_line_string")); 
        ...
        public void issue_111_pointhandler_with_invalid_values()
        {
            ...
            string tempPath = Path.GetFileNameWithoutExtension(Path.GetTempFileName());
            Assert.Throws<ArgumentException>(() => features.SaveToShapefile(tempPath));
        }
        ...
        public void WriteShouldWriteMultiPoints()
        {
            ...
            foreach (var readFeature in ShapefileReader.ReadAll(filename))
            {
                Assert.IsNotNull(readFeature.Geometry);
                Assert.IsInstanceOf<MultiPoint>(readFeature.Geometry);
                Assert.AreEqual("Id", feature.Attributes.GetNames()[0]);
                Assert.AreEqual(10, feature.Attributes["Id"]);
            }
        }
    }
}
