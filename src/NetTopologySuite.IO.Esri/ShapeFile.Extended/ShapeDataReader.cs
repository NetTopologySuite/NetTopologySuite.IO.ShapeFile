...
namespace NetTopologySuite.IO.ShapeFile.Extended
{
    public class ShapeDataReader : IDisposable
    {
        ...
        public ShapeDataReader(string shapeFilePath, ISpatialIndex<ShapeLocationInFileInfo> index, GeometryFactory geoFactory, bool buildIndexAsync)
            :this(new StreamProviderRegistry(shapeFilePath, true, true), index, geoFactory, buildIndexAsync)
        {
        }

        public ShapeDataReader(StreamProviderRegistry streamProviderRegistry , ISpatialIndex<ShapeLocationInFileInfo> index, GeometryFactory geoFactory, bool buildIndexAsync)
        {
            ...
            m_DbfReader = new DbaseReader(streamProviderRegistry.DataStream);
        }
