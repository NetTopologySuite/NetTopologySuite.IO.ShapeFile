...
namespace NetTopologySuite.IO.ShapeFile.Extended
{
    ...
    public class ShapeReader : IDisposable
    {
        ...
        private readonly StreamProviderRegistry m_StreamProviderRegistry;
        ...
        public ShapeReader(string shapefilePath) : this(new StreamProviderRegistry(shapefilePath, true))
        {
        }

        public ShapeReader(StreamProviderRegistry streamProviderRegistry)
        {
            ...
            get
            {
                ...
                if (m_ShapeFileReader == null)
                {
                    lock (m_StreamProviderRegistry)
                    {
                        if (m_ShapeFileReader == null)
                        {
                            m_ShapeFileReader = new BigEndianBinaryReader(m_StreamProviderRegistry.ShapeStream.OpenRead());
                        }
                    }
                }
        ...
        public IEnumerable<MBRInfo> ReadMBRs()
        {
            ...
            lock (m_StreamProviderRegistry)
            {
                var newReader = new BigEndianBinaryReader(m_StreamProviderRegistry.ShapeStream.OpenRead());
        ...
        {
            using (var shapeFileReader = new BigEndianBinaryReader(m_StreamProviderRegistry.ShapeStream.OpenRead()))
            {
